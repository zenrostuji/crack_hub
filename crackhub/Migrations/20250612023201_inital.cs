    ...
    public partial class inital : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PremiumRegisters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PremiumRegisters_Premiums_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Premiums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PremiumRegisters_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PremiumRegisters_PackageId",
                table: "PremiumRegisters",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_PremiumRegisters_UserId",
                table: "PremiumRegisters",
                column: "UserId");
